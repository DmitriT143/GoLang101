...
func main() {
	...
	if err != nil {
		fmt.Println("А почему файл не ПНГ:", err)
		return
	}
	...
	outFile, err := os.Create("ПараллельноОбработанныйСерыйШакал.png")
	if err != nil {
	...
	fmt.Println("Изображение сохранено ПараллельноОбработанныйСерыйШакал.png, там же где ты запустил программу")
}
